...
export function Hero() {
    return (
        <section className="relative overflow-hidden pt-32 pb-20 lg:pt-48 lg:pb-32">
            <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-dnd-gold/20 via-dnd-bg to-dnd-bg" />

            <div className="container mx-auto px-6 text-center">
                <h1 className="mb-6 text-5xl font-extrabold tracking-tight lg:text-7xl">
                    The Ultimate <span className="text-dnd-red">D&D</span> Companion
                </h1>
                ...
                <div className="flex flex-col justify-center gap-4 sm:flex-row">
                    <Link href="/register">
                        <Button className="h-12 bg-dnd-red px-8 text-lg shadow-lg shadow-dnd-red/20 hover:bg-dnd-crimson">
